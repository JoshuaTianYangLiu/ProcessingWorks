...
// the file Input.pde. There will now be 2 tabs in you new sketch with Input.pde being visible.
// Select the *other* tab and you can type in your program there. In order to use the code from
// Input.pde in your program you will need to use the function/method: void setup().
