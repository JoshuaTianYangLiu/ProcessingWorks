...
public class ImageToProcessing {
    ...
    public static void main(String[] args) throws Exception{
        ...
        System.out.println("Number of files to convert. Each picture should be in (1), in (2), ect");
        int times=readInt();
        if(times==1){
            ...
            for(int k=1; k<=times; k++){
                BufferedImage img = null; 
                File f = null; 
                FileWriter fileWriter = new FileWriter("C:\\Users\\Joshua\\Desktop\\ProcessingWorks\\JavaProgramsForShortcuts\\ImageToProcessingCode\\out ("+k+").txt");
                FileWriter fileWriter1 = new FileWriter("C:\\Users\\Joshua\\Desktop\\ProcessingWorks\\JavaProgramsForShortcuts\\ImageToProcessingCode\\debug ("+k+").txt");
                PrintWriter printWriter = new PrintWriter(fileWriter);
                PrintWriter printWriter1 = new PrintWriter(fileWriter1);

                try
                { 
                    f = new File("C:\\Users\\Joshua\\Desktop\\ProcessingWorks\\JavaProgramsForShortcuts\\ImageToProcessingCode\\in ("+k+").png"); 
                    img = ImageIO.read(f); 
                } 
                catch(Exception e) 
                { 
